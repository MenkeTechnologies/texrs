...
%     \pickup@font -- and `src/lower.rs::edef_snapshot' freezes `\the\count<n>'
%     and nothing else, so `\edef\f@size{\strip@pt\@tempdimb}' stops the load
%     with `Unsupported \edef body'. Measured, on this document. \strip@pt is
%     not ported for the same reason: its only caller would be that line.
